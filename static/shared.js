...
export function optionDetails(o){return `${o.spoiler?`<p class="option-description">${esc(o.spoiler)}</p>`:''}${o.consiliumTrial?'<small class="consilium-trial-note">После отправки заявки вы получите персональную ссылку на пятидневный тестовый доступ к сервису «Консилиум».</small>':''}`;}
